...
- 상태: Mock Core MVP 조건부 통과, Cooking Log 완료 리뷰 통과·Product Owner 승인 대기
...
3. `T-20260805-004` Cooking Log·STEP Preview 자동 저장·오류 상태 — `completion_review`, Lead PASS_WITH_RISK·PR #90 병합 승인 대기
