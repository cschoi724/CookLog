...
작성일: 2026-07-28
최종 업데이트: 2026-07-31
상태: T-008~011 반영 완료, T-012~014 순차 디자인 대기
...
- 로딩, 준비 오류, 단계 없음
- 현재 문서는 버튼 기반 기준까지 반영합니다. 첫 공개 출시 필수 핸즈프리·오디오 중단 상태는 T-20260729-012에서 추가합니다.
...
- 첫 공개 출시 필수 핸즈프리 음성 명령과 오디오 중단 상태: `T-20260729-012`
- 앱 정보·데이터 보관·법적 문서·서비스 장애 상태: `T-20260729-013`
- 전체 접근성 검증과 최종 구현 핸드오프: `T-20260729-014`

위 항목은 제품 출시 범위에서 제외된 것이 아니라 순차 Design Task의 반영 대기 범위입니다.
