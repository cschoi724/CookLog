...
| `T-20260805-004` | `completion_review` | iOS | Cooking Log·STEP Preview 자동 저장·오류 상태 | Product Owner | `T-20260805-003` 완료 | Lead PASS_WITH_RISK·PR #90 checks PASS, 완료·병합 승인 대기 |
