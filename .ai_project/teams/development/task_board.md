...
| `T-20260731-003` | `proposed` | CI/Ops | GitHub Actions 사용량 절감 및 실행 정책 최적화 | Development Lead Agent | `T-20260730-005` | WP-1~5 iOS Agent, WP-6~7 AI Ops Agent 배정·실행 승인 대기 |
