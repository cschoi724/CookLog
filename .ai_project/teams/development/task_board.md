...
| `T-20260804-004` | `approved` | Backend | Mock AI recipe job·status·ACK·복구 | Backend Agent | `T-20260804-002`, `003` 완료 | Product Owner 별도 실행 승인, 전용 worktree lock 후 구현 |
...
| `T-20260805-002` | `verification_passed` | iOS | 로컬 도메인·SwiftData migration·draft 생명주기 | Development Lead Agent | 디자인 기준 완료 | HIGH 2건 해소·전체 43/43 독립 QA 통과, 완료 검토 |
