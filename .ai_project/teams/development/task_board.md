...
| `T-20260804-004` | `verification_ready` | Backend | Mock AI recipe job·status·ACK·복구 | Backend QA Agent | `T-20260804-002`, `003` 완료 | HIGH 2·MEDIUM 1 수정·55/55 PASS, 독립 재검증 대기 |
