...
| `T-20260730-007` | `verification_ready` | iOS/CI | iOS 26.5 SwiftData XCTest crash 진단과 최소 수정 | iOS QA Agent | T-001 QA-HIGH-001 | QA-HIGH-007-001 해소 독립 재검증 |
...
`QA-HIGH-007-001` 재작업으로 allowed_paths 밖 루트 Task board 변경을 제거했으며,
iOS QA의 변경 범위 독립 재검증을 기다립니다.
