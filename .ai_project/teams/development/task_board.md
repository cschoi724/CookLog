...
| `T-20260804-004` | `verification_passed` | Backend | Mock AI recipe job·status·ACK·복구 | Development Lead Agent | `T-20260804-002`, `003` 완료 | Backend QA PASS_WITH_RISK, 완료 검토·잔여 위험 수용 판단 |
