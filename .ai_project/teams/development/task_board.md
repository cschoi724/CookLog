...
| `T-20260805-006` | `verification_ready` | iOS | Audio Guide·핸즈프리 UI·공통 action model | iOS QA Agent | `T-20260805-005` 완료 | QA-HIGH-806006-001 safeAreaInset 수정·77/77·4 viewport 재검증 요청 |
