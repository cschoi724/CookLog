...
| `T-20260728-006` | `completion_review` | Backend | Backend AI gateway와 비활성 원격 STT adapter foundation 구현 | Development Lead Agent | 하위 `T-20260804-002~007` 완료 | Lead PASS_WITH_RISK·Product Owner 최종 완료/정합화 PR 승인 대기 |
