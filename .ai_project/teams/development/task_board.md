...
| `T-20260804-005` | `rework_requested` | Backend | 원격 STT 비활성 확장 경계·활성화 차단 | Development Lead Agent | `T-20260804-002`, `003` 완료 | QA-HIGH-005-001 실제 startup이 무승인 원격 STT 설정 9종 수용·재작업 경로 조율 |
