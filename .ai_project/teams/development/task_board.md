...
| `T-20260805-008` | `verification_ready` | iOS | 접근성·작은 화면·다크 모드·통합 회귀 | iOS QA Agent | `T-20260805-002~007` 완료 | 82/82·계약 validator·A3 viewport 표본 완료, 전체 23 capture/Diff/VoiceOver 독립 검증 대기 |
