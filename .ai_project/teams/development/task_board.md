...
| `T-20260728-003` | `proposed` | iOS | 승인된 Figma MVP UI/UX를 iOS 앱에 적용 | Development Lead Agent | `T-20260728-001` 대기, `T-20260728-002`·`T-20260805-001` 완료 | iOS M8 Task 완료 후 scope |
...
| `T-20260728-009` | `proposed` | Release | iOS 실서비스 전환 준비도와 릴리즈 게이트 정의 | Development Lead Agent | `T-20260728-002` 완료, 나머지 3개 대기 | 선행 기준 확정 후 scope |
