...
| `T-20260810-003` | `completion_review` | Backend | App Attest·설치 token·abuse 방어 | Development Lead Agent | Backend Foundation 완료 | Lead PASS_WITH_RISK·durable revocation/key 회전 replay/실제 Apple·KMS는 T-006 gate·Product Owner 승인 대기 |
