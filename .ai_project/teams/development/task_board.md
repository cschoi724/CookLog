...
| `T-20260805-006` | `rework_requested` | iOS | Audio Guide·핸즈프리 UI·공통 action model | iOS Agent | `T-20260805-005` 완료 | QA-HIGH-806006-001: 375×667에서 재료 CTA가 하단 control bar에 가려짐 |
