...
| `T-20260728-005` | `scoped` | Backend | Backend AI gateway와 기본 비활성 원격 STT adapter 계약 정의 | Development Lead Agent | 하위 `T-20260729-020~025` | T-020~023 `done`, T-024 QA 인계, T-025 승인·T-024 선행 대기 |
...
| `T-20260729-024` | `verification_ready` | Backend | 보안·개인정보·관측성·비용 guardrail | Backend QA Agent | `T-20260729-020`, `021` 완료 | 자체 검증 완료, Backend QA 독립 검증 |
...
T-020~023은 `done`이고 T-024는 자체 검증 후 Backend QA 독립 검증에 인계했습니다.
