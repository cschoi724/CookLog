...
| `T-20260804-005` | `verification_ready` | Backend | 원격 STT 비활성 확장 경계·활성화 차단 | Backend QA Agent | `T-20260804-002`, `003` 완료 | disabled resolver·HTTP 선차단·config fail-closed 구현, 전체 65/65·독립 QA 대기 |
