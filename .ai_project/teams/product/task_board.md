...
| `T-20260812-004` | `done` | 비공개 Figma 원천 전환 기반 Task 흐름·의존성 재정렬 | - | `T-20260812-002` 완료 | Product QA `PASS_WITH_RISK`·Completion Review 수용; T-003 Design Lead scope 선행 조건 해제 |
