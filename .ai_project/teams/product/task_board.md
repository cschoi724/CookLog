...
| `T-20260812-002` | `verification_ready` | 팝 키치 레시피 클럽 UX 구조·핵심 기능 재기획 | Product QA Agent / Verification Role | 없음 | 82개 상태 계약 추적표·390×844pt 기준·Home 단일 전체 보기 baseline 재작업 독립 검증 대기 |
