...
| `T-20260812-002` | `approved` | 팝 키치 레시피 클럽 UX 구조·핵심 기능 재기획 | Product Planning Agent / Execution Role | 없음 | 82개 상태·데이터/복구 계약 결정표와 Home 단일 전체 보기 baseline 보완 실행 승인; 375×667pt 전체 명세는 기본 범위 제외 |
