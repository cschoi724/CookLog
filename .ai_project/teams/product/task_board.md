...
| `T-20260812-002` | `rework_requested` | 팝 키치 레시피 클럽 UX 구조·핵심 기능 재기획 | Product Lead Agent / Lead Role | 없음 | Product QA FAIL: 82개 상태 계약 결정표·Home 외 375×667 명세·Home 전체 보기 baseline 보완 범위 조율 |
