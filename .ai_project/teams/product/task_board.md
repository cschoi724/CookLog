...
| `T-20260812-004` | `scoped` | 비공개 Figma 원천 전환 기반 Task 흐름·의존성 재정렬 | Product Lead Agent / Direction Role | `T-20260812-002` 완료 | T-003 중심의 기존 디자인·iOS·QA Task 분류·canonical 실행 순서 패키지 승인 대기 |
