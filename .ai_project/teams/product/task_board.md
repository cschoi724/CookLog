...
| `T-20260812-004` | `rework_requested` | 비공개 Figma 원천 전환 기반 Task 흐름·의존성 재정렬 | Product Lead Agent / Lead Role | `T-20260812-002` 완료 | Product QA FAIL; T-003 Handoff·T-004 현재 결과·diff 검증 증거 정합성 보완 필요 |
