...
| `T-20260813-002` | `rework_requested` | 비공개 Figma 기록·레시피 핵심 흐름 | Design Lead Agent / Lead Role | `T-20260813-001` 완료 | DQA-002-001 AX3 Cooking Log 상태 불일치와 DQA-002-002 action 집계 정합성 수정·승인 후 UI/UX 재작업 → 독립 재검증 |
