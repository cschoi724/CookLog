...
| `T-20260813-001` | `approved` | 비공개 Figma Foundations·Home Visual Baseline | UI/UX Design Agent / Execution Role | `T-20260812-004` | Product Owner 승인 범위로 DQA-001·002 일반 Light/Dark Error retry·Delete confirm cancel/delete의 최소 44×44pt action target 보완 후 재검증 |
