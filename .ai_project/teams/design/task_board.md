...
| `T-20260729-002` | `in_progress` | 확정 제품 UX 기반 디자인 시스템·프로토타입 갱신 | Design Lead Agent | `T-20260729-001`, `T-20260729-008~014` | 하위 Task 범위 Product Owner 승인 |
| `T-20260729-008` | `proposed` | 확정 UX용 디자인 Foundation·공통 컴포넌트 갱신 | UI/UX Design Agent | 없음 | 범위 승인 후 첫 실행 |
