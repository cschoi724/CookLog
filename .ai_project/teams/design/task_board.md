...
| `T-20260813-002` | `approved` | 비공개 Figma 기록·레시피 핵심 흐름 | UI/UX Design Agent / Execution Role | `T-20260813-001` 완료 | Library·Cooking Log·AI Review·Recipe Detail 38상태 실행 승인 |
