...
| `T-20260813-001` | `rework_requested` | 비공개 Figma Foundations·Home Visual Baseline | Design Lead Agent / Lead Role | `T-20260812-004` | 일반 Light/Dark Error·Delete confirm의 DQA-001·002 44pt action target 보완 후 재검증 |
