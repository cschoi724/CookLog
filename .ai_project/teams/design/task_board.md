...
| `T-20260813-003` | `approved` | 비공개 Figma Audio·Info·82상태 완결 | UI/UX Design Agent / Execution Role | `T-20260813-002` 완료 | Product Owner 실행 승인·Design QA 독립 검증 조건; lock 획득 후 실행 |
