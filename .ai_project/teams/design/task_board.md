...
| `T-20260813-001` | `approved` | 비공개 Figma Foundations·Home Visual Baseline | UI/UX Design Agent / Execution Role | `T-20260812-004` | PR #163 인계·비공개 Draft read-only 접근 확인; verification_ready 재인계 후 같은 Draft로 Design QA 독립 재검증 |
