...
| `T-20260811-004` | `verification_ready` | 팝 키치 레시피 클럽 Foundation·Home·Library 원본 시안 재작업 | Design QA Agent | T-003 완료 이력·원본 concept | Foundation → Home → Library 재작업 및 자체 검증 완료·독립 재검증 대기 |
