...
| `T-20260812-003` | `scoped` | CookLog 비공개 Figma 원천 전환과 팝 키치 핵심 흐름 UI/UX 원본 구축 | Product Lead Agent / Lead Role | `T-20260812-004`, T-20260813-001~004 | 상위 완료 집계·Product Lead review·Product Owner 실행 승인 대기 |
