...
|---|---|---|---|---|
| `T-20260805-006` | `verification_ready` | iOS Audio Guide·핸즈프리 UI·공통 action model | safeAreaInset 재작업·77/77·390×844/375×667 Light/Dark 4/4 | QA-HIGH-806006-001 독립 재검증 |
