...
| `T-20260804-003` | `approved` | Backend 공통 HTTP·인증·제한·idempotency middleware | HIGH 2: violation secret 누출·strict schema prototype-key 우회, MEDIUM 1: `/v2?query` 오분류 | Product Owner 재작업 승인, Backend Agent 수정 후 독립 재검증 |
