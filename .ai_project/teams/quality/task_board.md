...
| `T-20260804-005` | `verification_ready` | Backend 원격 STT 비활성 확장 경계·활성화 차단 | disabled profile·route/body read/queue/egress 0·무승인 config 차단 | Backend 전체 65/65, Backend QA 독립 검증 대기 |
