...
| `T-20260804-005` | `completion_review` | Backend 원격 STT 비활성 확장 경계·활성화 차단 | disabled profile·startup 30개 반례·route/body read/queue/egress 0 | Lead PASS_WITH_RISK 수용, Product Owner 완료·PR #84 병합 승인 대기 |
