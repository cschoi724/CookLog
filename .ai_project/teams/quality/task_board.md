...
|---|---|---|---|---|
| `T-20260805-006` | `completion_review` | iOS Audio Guide·핸즈프리 UI·공통 action model | QA-HIGH-806006-001 해소·독립 77/77·4 viewport | Lead PASS_WITH_RISK·PR/필수 checks 준비 대기 |
