...
|---|---|---|---|---|
| `T-20260804-007` | `rework_requested` | Backend Foundation 통합 계약·보안 검증·handoff | Node 24 container·composition·HTTP/fixture 동등성·보안/비용/cleanup 전체 회귀 | Product Owner fail-closed 재작업 승인, 수정 후 독립 재검증 |
