...
| `T-20260804-005` | `approved` | Backend 원격 STT 비활성 확장 경계·활성화 차단 | disabled profile·route/body read/queue/egress 0·무승인 config 차단 | Product Owner 재작업 승인, startup 연결 수정 후 독립 재검증 |
