...
|---|---|---|---|---|
| `T-20260805-002` | `approved` | iOS 로컬 도메인·SwiftData migration·draft 생명주기 | 단일 UUID 전이·여러 draft 복구·legacy completed·rollback·전체 XCTest | Product Owner 재작업 승인, iOS Agent 수정 후 독립 재검증 |
