...
| `T-20260731-003` | `approved` | GitHub Actions 사용량 절감 및 실행 정책 최적화 | paths filter·concurrency·문서 PR 제외·수동/야간 회귀·Budget 운영 | iOS Agent WP-1~5 실행 후 iOS QA·AI Ops 독립 검증 |
