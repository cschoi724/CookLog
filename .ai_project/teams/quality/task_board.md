...
|---|---|---|---|---|
| `T-20260810-005` | `verification_passed` | Backend production 원격 STT·음성 upload 비활성 보증 | zero-capability·strict proof·request/error·비로깅·155/155·감사 mutation 12종 PASS_WITH_RISK | Completion 검토 전 Node 24 non-root container required check |
