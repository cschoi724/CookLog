...
|---|---|---|---|---|
| `T-20260810-003` | `verification_passed` | Backend App Attest·설치 token·abuse 방어 | Node 24/26 135/135·인증/원자 replay/rate cap PASS, durable revocation 위험 | Completion Role 위험 수용·T-006 gate 검토 |
