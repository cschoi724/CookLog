...
| `T-20260804-005` | `verification_ready` | Backend 원격 STT 비활성 확장 경계·활성화 차단 | disabled profile·startup 30개 반례·route/body read/queue/egress 0 | QA-HIGH-005-001 수정·전체 66/66, Backend QA 독립 재검증 대기 |
