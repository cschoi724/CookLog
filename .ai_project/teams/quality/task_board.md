...
| `T-20260729-020` | `verification_passed` | Backend 런타임·배포·AI provider·비용 후보 결정안 | 기존 PASS_WITH_RISK 내용 동등성·허용 경로·공용 보드 비회귀 | PASS_WITH_RISK, Development Lead 완료 검토 |
