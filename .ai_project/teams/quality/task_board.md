...
|---|---|---|---|---|
| `T-20260728-006` | `completion_review` | Backend AI gateway·비활성 원격 STT Foundation | 하위 T-002~007 독립 QA·100/100·계약 5종·Node 24 container 집계 | Lead PASS_WITH_RISK·Product Owner 최종 완료 승인 대기 |
