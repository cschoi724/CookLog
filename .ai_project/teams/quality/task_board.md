...
| `T-20260731-003` | `verification_ready` | GitHub Actions 사용량 절감 및 실행 정책 최적화 | 경량 path 판정·동적 runner·concurrency·check 이름·실패 65·timeout 124 | iOS QA 독립 검증, WP-6~7 AI Ops 별도 인계 |
