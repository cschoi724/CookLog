...
|---|---|---|---|---|
| `T-20260805-002` | `verification_ready` | iOS 로컬 도메인·SwiftData migration·draft 생명주기 | HIGH 2건 해소·단일 UUID·legacy completed·non-empty migration·전체 XCTest | iOS Agent 재작업 완료, iOS QA 독립 재검증 |
