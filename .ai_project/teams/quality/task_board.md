...
| `T-20260730-001` | `rework_requested` | iOS CI 환경·명령·check 계약 확정 | T-004 로컬 환경과 hosted CI 차이, 고정 runner·toolchain·destination·timeout·artifact | `FAIL`, iOS 26.5 SwiftData crash 재작업 |
