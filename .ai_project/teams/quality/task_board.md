...
| `T-20260804-005` | `verification_passed` | Backend 원격 STT 비활성 확장 경계·활성화 차단 | disabled profile·startup 30개 반례·route/body read/queue/egress 0 | PASS_WITH_RISK: HIGH 해소·66/66, Development Lead 완료 검토 인계 |
