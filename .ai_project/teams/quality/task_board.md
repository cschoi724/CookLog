...
|---|---|---|---|---|
| `T-20260804-007` | `rework_requested` | Backend Foundation 통합 계약·보안 검증·handoff | Node 24 container·composition·HTTP/fixture 동등성·보안/비용/cleanup 전체 회귀 | QA-HIGH-007-001 terminal telemetry 장애 뒤 미감사 성공 결과 공개, Lead 재작업 조율 |
