...
| `T-20260730-006` | `verification_ready` | ios-build·ios-xctest required check 외부 설정 | source `15368`·PR #58 failure BLOCKED→복구 CLEAN·Budget 화면 | HIGH 2건 재작업 완료, iOS QA 독립 재검증 대기 |
...
| `T-20260730-006` | CI/Ops | iOS QA Agent | ruleset source `15368`, PR #58 실패·복구 상태 전이와 Budget 화면 독립 재검증 |
