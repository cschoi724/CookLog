...
| `T-20260729-023` | `completion_review` | AI recipe job·상태 조회·결과 복구 계약 | result version ACK·provider 시작 전후 timeout 6개·quota create HTTP 429 | QA PASS_WITH_RISK 확인, develop 통합 대기 |
