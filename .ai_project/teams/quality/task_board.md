...
| `T-20260805-005` | `completion_review` | iOS AI Review·완료 Recipe 편집·삭제 | Review 5개 상태·동일 UUID/STEP·snapshot 복원·완료 수정/삭제·실패 보존·전체 회귀 통과 | Lead PASS_WITH_RISK·Product Owner 완료/병합 승인 대기 |
