...
| `T-20260730-003` | `verification_passed` | ios-xctest 직렬 실행·timeout·artifact workflow 구현 | 독립 33/33, 일반 실패 65, timeout 124와 log·xcresult·marker | PASS_WITH_RISK, hosted 실행은 QA-RISK-003-001 |
