...
| `T-20260804-005` | `rework_requested` | Backend 원격 STT 비활성 확장 경계·활성화 차단 | disabled profile·route/body read/queue/egress 0·무승인 config 차단 | FAIL: QA-HIGH-005-001 startup validator 미연결, Development Lead 재작업 조율 |
