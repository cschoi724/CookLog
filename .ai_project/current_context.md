...
- Product `T-20260731-001`은 Product QA 최종 `PASS`와 Product Lead 완료 검토를 수용해 `completion_review`이며 Product Owner 최종 완료 승인 대기 상태입니다.
...
- T-20260731-001은 Product Lead 완료 검토를 통과했으며 Product Owner 최종 승인 전 T-20260728-003 차단을 해제하지 않습니다.
