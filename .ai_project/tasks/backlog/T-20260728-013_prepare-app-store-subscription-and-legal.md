...
- 문서·상품 준비 실행: Product Planning Agent / Execution Role, 외부 App Store Connect 변경은 별도 Product Owner 승인
- 독립 검증: Product QA Agent, 기술·상품 설정은 필요한 경우 iOS QA Agent와 교차 검증
- 완료 검토: Product Lead Agent / Completion Role
