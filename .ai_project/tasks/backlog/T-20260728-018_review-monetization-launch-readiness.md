...
- 출시 근거 취합과 문서 실행: Product Planning Agent / Execution Role
- 독립 검증: Product QA Agent가 T-017의 iOS·Backend QA 결과와 제품 정책을 교차 검증
- `verification_passed -> completion_review`: Product Lead Agent / Completion Role
- 실제 수익화 출시 포함과 외부 변경: Product Owner 최종 승인
