...
| `T-20260812-002` | P1 | 팝 키치 레시피 클럽 UX 구조·핵심 기능 재기획 | Product Lead Agent | `verification_passed`, Product QA `PASS_WITH_RISK`; 82개 상태·Home 단일 진입점 통과, 375×667 Legacy 충돌은 T-004 후속 리스크 |
...
| `T-20260812-004` | P0 | 비공개 Figma 원천 전환 기반 Task 흐름·의존성 재정렬 | Product Lead Agent | `proposed`, T-002 완료 후 컨셉·기획·디자인·iOS·QA Task의 유지·보류·재범위화와 실행 순서 조율 |
