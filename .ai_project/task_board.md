...
| `T-20260729-003` | P0 | 실제 AI provider와 배포 가능한 Backend gateway 구축 | Development Lead Agent | `scoped`, 6개 하위 Task·외부 결정/승인 대기 |
