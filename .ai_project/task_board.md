...
| `T-20260812-002` | P1 | 팝 키치 레시피 클럽 UX 구조·핵심 기능 재기획 | Product Lead Agent | `completion_review`, Product QA `PASS_WITH_RISK` 수용; 375×667 Legacy 충돌을 T-20260812-004 후속 리스크로 분리 |
