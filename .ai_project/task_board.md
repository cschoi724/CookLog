...
| Design | 4 | 1 | 0 | `.ai_project/teams/design/task_board.md` |
...
| `T-20260811-004` | P1 | 팝 키치 레시피 클럽 Foundation·Home·Library 원본 시안 재작업 | Design QA Agent | `verification_ready`, Foundation → Home → Library 재작업·자체 검증 완료·독립 Design QA 대기 |
| `T-20260811-008` | P1 | 팝 키치 레시피 클럽 Visual Fidelity 리터치 및 시각 승인 | Design Lead Agent → UI/UX Design Agent | `proposed`, T-004 이후·Home 고충실도·Product Owner 시각 승인 |
