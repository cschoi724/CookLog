...
Product `T-20260731-001`은 Development Board Backend 상위 요약을 T-020~022 `done`, T-023·024 `approved`, T-025 선행 대기로 정렬하고 Product QA 독립 재검증 대기 상태입니다. Design `T-20260729-002`의 Lead scope는 진행 중이고 `T-20260729-008~011`은 `done`입니다. Backend T-020~022는 `done`, T-023·024는 `approved`, T-025는 선행 대기입니다. CI T-001~004는 `done`, T-005~006은 후속 승인·검증 대상입니다.
...
| `T-20260731-001` | P0 | 활성 문서 Source of Truth 정합성 복구 | Product QA Agent | `verification_ready`, Backend 상위 요약 재작업 독립 재검증 |
