...
iOS MVP 디자인 적용과 Visual QA에 필요한 계약을 확정했다. 승인된 23개 디자인 상태를 현재 SwiftUI View·ViewModel 조건에 1:1로 대응하고, 디자인 고유 요구와 iOS 네이티브 적응의 우선순위, 측정 가능한 허용 편차, 접근성, 컴포넌트·에셋 인계를 한 문서로 묶었다.
...
- `design/COOKLOG_MVP_UIUX_V1_HANDOFF.md` iOS 구현 인계 절 보강
...
- `T-20260728-003`의 기존 사용자 결정 필요 항목 2개 해소 확인
- `git diff --check`: 통과
- Figma MCP 호출: 0회
- iOS 코드 변경: 0건
...
- 23개 상태의 Preview/UI fixture와 자동 캡처 기반은 후속 구현 Task에서 마련해야 한다.
